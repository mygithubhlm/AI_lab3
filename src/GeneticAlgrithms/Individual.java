...
//	总重
	...
	private ArrayList<Gene> getAllGenes() {
		...
		all_the_genes = randomList(all_the_genes);

		Collections.shuffle(all_the_genes);
...
//	基因复制
	...
	public Individual create_a_individual(){
		...
		if (this.type == Type.TSP) {
			...
			chromesome = randomList(chromesome);
		}else{
			randomInitial(allgenes);
		}
		return this;
	}
...
//		double temp = Math.round(result * 100000)/100000;
	...
	public double getWeight(){
		...
		double temp = Math.round(result * 1000000000)/1000000000;
		return temp;
	}
